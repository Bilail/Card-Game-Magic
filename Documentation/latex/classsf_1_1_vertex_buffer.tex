\hypertarget{classsf_1_1_vertex_buffer}{}\doxysection{Référence de la classe sf\+::Vertex\+Buffer}
...
Graphe d\textquotesingle{}héritage de sf\+::Vertex\+Buffer\+:\begin{figure}[H]
\begin{center}
\leavevmode
...
If data is going to be updated once or more every frame, set the usage to Stream. If data is going to be set once and used for a long time without being modified, set the usage to Static. For everything else Dynamic should be a good compromise. \begin{DoxyEnumFields}{Valeurs énumérées}
...
\item 
Source/dependance/\+SFML/include/\+SFML/\+Graphics/\mbox{\hyperlink{_vertex_buffer_8hpp}{Vertex\+Buffer.\+hpp}}\end{DoxyCompactItemize}
